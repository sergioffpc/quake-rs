...
pub fn read_i16_bounding_box<R>(reader: &mut R) -> anyhow::Result<quake_collision::BoundingVolume>
where
    R: std::io::Read,
{
    quake_collision::BoundingVolume::read_bounding_box_with(reader, |r| read_i16_vector3_as_f32(r))
}

pub fn read_f32_bounding_box<R>(reader: &mut R) -> anyhow::Result<quake_collision::BoundingVolume>
where
    R: std::io::Read,
{
    quake_collision::BoundingVolume::read_bounding_box_with(reader, |r| read_f32_vector3(r))
}
