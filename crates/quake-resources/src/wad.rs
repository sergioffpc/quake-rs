...
impl Wad {
    pub async fn from_slice(data: &[u8]) -> anyhow::Result<Self> {
        ...
        let directory_count = reader.read_u32_le().await? as u64;
        ...
        T: AsyncReadExt + AsyncSeekExt + Unpin + Send,
    {
        ...
        for _ in 0..directory_count {
            ...
            let entry_type = WadEntryType::from_i32(reader.read_u8().await? as i32)?;
